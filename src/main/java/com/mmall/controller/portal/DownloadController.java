...
public class DownloadController {
    ...
    private static final String FILE_PATH = "/Users/eric/Downloads/pic.jpg";
    private static final String APPLICATION_JPG = "application/jpg";


//    via HttpServletResponse
    @RequestMapping(value = "/a.do", method = RequestMethod.GET, produces = APPLICATION_JPG)
    public @ResponseBody
...
//    via HttpEntity
    @RequestMapping(value = "/b.do", method = RequestMethod.GET, produces = APPLICATION_JPG)
    public @ResponseBody
    ...
    @RequestMapping(value = "/c.do", method = RequestMethod.GET, produces = APPLICATION_JPG)
    public @ResponseBody
